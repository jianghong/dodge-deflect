...
/////// Diffuse:
                ...
                float3 diffuse = directDiffuse * lerp(0.02,0.2,(pow(1.0-max(0,dot(normalDirection, viewDirection)),_OuterColourStrength)*_OuterColour.rgb));
/// Final Color:
