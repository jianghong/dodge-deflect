...
/*SF_DATA;ver:1.05;sub:START;pass:START;ps:flbk:,lico:1,lgpr:1,nrmq:1,limd:1,uamb:True,mssp:True,lmpd:False,lprd:False,rprd:False,enco:False,frtr:True,vitr:True,dbil:False,rmgx:True,rpth:0,hqsc:True,hqlp:False,tesm:0,blpr:0,bsrc:0,bdst:1,culm:0,dpts:2,wrdp:True,dith:0,ufog:True,aust:True,igpj:False,qofs:0,qpre:1,rntp:1,fgom:False,fgoc:False,fgod:False,fgor:False,fgmd:0,fgcr:0.5,fgcg:0.5,fgcb:0.5,fgca:1,fgde:0.01,fgrn:0,fgrf:300,ofsf:0,ofsu:0,f2p0:False;n:type:ShaderForge.SFN_Final,id:664,x:33273,y:32870,varname:node_664,prsc:2|diff-7968-OUT;n:type:ShaderForge.SFN_Fresnel,id:1895,x:32661,y:32925,varname:node_1895,prsc:2|EXP-2561-OUT;n:type:ShaderForge.SFN_Slider,id:2561,x:32517,y:32787,ptovrint:False,ptlb:OutsideEdge,ptin:_OutsideEdge,varname:node_2561,prsc:2,min:0,cur:3.774634,max:25;n:type:ShaderForge.SFN_Color,id:3105,x:32661,y:33102,ptovrint:False,ptlb:node_3105,ptin:_node_3105,varname:node_3105,prsc:2,glob:False,c1:3,c2:0.3,c3:0.5,c4:1;n:type:ShaderForge.SFN_Multiply,id:7968,x:32865,y:33012,varname:node_7968,prsc:2|A-1895-OUT,B-3105-RGB;proporder:2561-3105;pass:END;sub:END;*/

Shader "Shader Forge/BlackHoleShader" {
    Properties {
        _OutsideEdge ("OutsideEdge", Range(0, 25)) = 3.774634
        _node_3105 ("node_3105", Color) = (3,0.3,0.5,1)
    }
    SubShader {
        Tags {
            "RenderType"="Opaque"
