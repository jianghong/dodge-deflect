...
/////// Diffuse:
                ...
                float3 diffuse = (directDiffuse + indirectDiffuse) * (_diffusepower*_colour.rgb);
/// Final Color:
...
/////// Diffuse:
                NdotL = max(0.0,dot( normalDirection, lightDirection ));
                float3 directDiffuse = max( 0.0, NdotL) * attenColor;
                float3 diffuse = directDiffuse * (_diffusepower*_colour.rgb);
/// Final Color:
                float3 finalColor = diffuse + specular;
