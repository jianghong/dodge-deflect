...
////// Emissive:
                ...
                float3 finalColor = emissive + (attenuation*_LightColor0.rgb*((pow(dot(halfDirection,i.normalDir),_glossiness)*_specularity*_SpecularityColour.rgb)+min(0,dot(lightDirection,i.normalDir))));
...
////// Lighting:
                float attenuation = LIGHT_ATTENUATION(i);
                float3 finalColor = (attenuation*_LightColor0.rgb*((pow(dot(halfDirection,i.normalDir),_glossiness)*_specularity*_SpecularityColour.rgb)+min(0,dot(lightDirection,i.normalDir))));
